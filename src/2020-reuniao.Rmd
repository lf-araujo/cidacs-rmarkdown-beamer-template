...
author:
- Me^[Post Doc | Center of Data and Knowledge Integration for Health (CIDACS) | Salvador | Brasil] ^[The University of Melbourne| Dept of Psychiatry| Austin Health | email:ldearaujo@unimelb.edu.au]
date: \today
...
```{r out.width='100%'}
knitr::include_graphics("../graphs/schedule.png")
```
